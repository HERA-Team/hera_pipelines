...
# This script generates a notebook for inspecting the results of XRFI
...
python ${src_dir}/build_notebook_readme.py ${nb_output_repo}/rfi_inspect
...
then
    ...
    git add ${nb_outfile}
    git commit -m "H1C IDR3 rfi notebook for JD ${jd}"
