...
input=zen.${jd}.${label}.xtalk_filtered_res.uvp
# form power spectrum between even and odd data sets with offset times.
# combine files

combined=zen.${int_jd}.${label}.xtalk_res.uvp
combine_pspec.py ${intput} ${ps_list} ${combined}
combined=zen.${int_jd}.${label}.xtalk_res.t_avg.uvp
combine_pspec.py ${input} ${ps_list} ${combined} --time_avg
rm -rf ${ps_list}
...
# combine files
combined=zen.${int_jd}.${label}.xtalk_res.uvp
combine_pspec.py ${ps_list} ${combined}
combine_pspec.py ${ps_list} ${combined} --time_avg
rm -rf ${ps_list}
