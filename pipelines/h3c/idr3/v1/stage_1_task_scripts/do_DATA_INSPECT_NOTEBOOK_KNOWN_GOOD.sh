...
jd=$(get_int_jd ${fn})
nb_outfile=${nb_output_repo}/data_inspect_known_good/data_inspect_known_good_${jd}.ipynb
...
then
    ...
    git add ${nb_outfile}
    git commit -m "H3C IDR3 data inspection of known good antennas for JD ${jd}"
