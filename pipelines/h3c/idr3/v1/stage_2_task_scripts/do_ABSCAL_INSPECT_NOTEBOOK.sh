...
# This script generates a notebook for inspecting the results of absolute calibration calibration for stage 2 analysis
...
jd=$(get_int_jd ${fn})
nb_outfile=${nb_output_repo}/stage_2_abscal/stage_2_abscal_${jd}.ipynb
...
then
    ...
    git add ${nb_outfile}
    git commit -m "H3C IDR3 stage 2 abscal notebook for JD ${jd}"
