...
auto_diff_even=zen.${jd}.even.${label}.auto.foreground_filled_waterfall.diff.tavg.uvh5
auto_diff_odd=${auto_diff_even/even/odd}
...
fgfilled_diff_even=zen.${jd}.even.${label}.xtalk_filtered_waterfall_withforegrounds.diff.tavg.${data_ext}
fgfilled_diff_odd=${fgfilled_diff_even/even/odd}
...
fgres_diff_even=zen.${jd}.even.${label}.xtalk_filtered_waterfall_withforegrounds.diff.tavg.${data_ext}
fgres_diff_odd=${fgres_diff_even/even/odd}
...
then
  ...
  echo time_average_baseline_parallelized.py ${auto_in_even} ${auto_out_even} ${auto_list_even} ${t_avg_arg}\
...
then
  ...
  echo time_average.py ${fgres_in_even} ${fgres_out_even} ${t_avg_arg} --rephase --clobber --flag_output ${tavg_flag}\
   --interleaved_input_data  ${fgres_in_odd} --interleaved_output_data ${fgres_out_odd}\
   --interleaved_diff_even ${fgres_diff_even} --interleaved_diff_odd ${fgres_diff_odd}

  time_average.py ${fgres_in_even} ${fgres_out_even} ${t_avg_arg} --rephase --clobber --flag_output ${tavg_flag}\
   --interleaved_input_data ${fgres_in_odd}  --interleaved_output_data ${fgres_out_odd}\
   --interleaved_diff_even ${fgres_diff_even} --interleaved_diff_odd ${fgres_diff_odd}
