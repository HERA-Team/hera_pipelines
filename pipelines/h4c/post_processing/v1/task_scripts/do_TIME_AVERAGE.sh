...
# even
echo time_average.py ${auto_in_even} ${auto_out_even} ${t_avg} --rephase --clobber
time_average.py ${auto_in_even} ${auto_out_even} ${t_avg} --rephase --clobber
# odd
echo time_average.py ${auto_in_odd} ${auto_out_odd} ${t_avg} --rephase --clobber
time_average.py ${auto_in_odd} ${auto_out_odd} ${t_avg} --rephase --clobber

# time-average no-fg resids -- use for id weight estimator.
# even
echo time_average.py ${nofg_in_even} ${nofg_out_even} ${t_avg} --rephase --clobber
time_average.py ${nofg_in_even} ${nofg_out_even} ${t_avg} --rephase --clobber
# odd
