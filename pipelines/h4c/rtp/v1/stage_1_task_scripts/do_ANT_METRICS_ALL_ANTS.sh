...
# 5 - all_ants_statuses: string list of comma-separated (no spaces) antenna statuses worth running ant_metrics on
...
jd=$(get_jd ${fn1})
apriori_xants=`query_ex_ants.py ${jd} ${all_ants_statuses}`
