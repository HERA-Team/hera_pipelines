...
all_html_files = [os.path.relpath(f) for f in glob.glob(os.path.join(args.target_dir, "../*/*.html")) if os.path.exists(f)]
...
overall_index += '    <li><a href="single_baseline_pI_SNR">single_baseline_pI_SNR</a></li>\n'
overall_index += '    <li><a href="full_day_rfi_round_4">full_day_rfi_round_4</a></li>\n'
...
overall_index += '    <li><a href="lststack_preliminary">lststack (preliminary runs)</a></li>\n'
overall_index += '    <li><a href="lststack">lststack (final runs)</a></li>\n'
overall_index += '</ul>\n</h3>\n'
overall_index += '<h2>Post-Processing and Power Spectrum Notebooks:</h2>\n<h3><ul>\n'
overall_index += '    <li><a href="single_lststack_baseline_pI_FRF_SNR">single_lststack_baseline_pI_FRF_SNR</a></li>\n'
overall_index += '    <li><a href="full_lststack_rfi_round_6">full_lststack_rfi_round_6</a></li>\n'
overall_index += '    <li><a href="single_lststack_baseline_reinpaint">single_lststack_baseline_reinpaint</a></li>\n'
