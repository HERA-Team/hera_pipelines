...
# and computes delay-filtered AND fringe-rate-filtered SNR waterfalls (saving only the FRF result).
...
echo Finished running single baseline pI FRF SNR notebook with FRF at $(date)
