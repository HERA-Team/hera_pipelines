...
# eligibility, so the set of preliminary-stacked baselines, lstcal anchors,
# and final-stack baselines is frozen here at the start of the run.
...
echo "SETUP: building baseline_map.yaml from ${toml_file}"
