...
# This function uploads all smooth_cal files to the Librarian
...
# 3 - librarian_smooth_cal: boolean trigger for this step
fn="${1}"
upload_to_librarian="${2}"
librarian_smooth_cal="${3}"
...
echo Finished running librarian smooth_cal at $(date)
