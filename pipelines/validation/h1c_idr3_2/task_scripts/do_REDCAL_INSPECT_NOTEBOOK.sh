...
# This script generates a notebook for inspecting the results of redundant baseline calibration
...
jd=$(get_int_jd ${fn})
nb_outfile=${nb_output_repo}/redcal_inspect/redcal_inspect_${jd}.ipynb
