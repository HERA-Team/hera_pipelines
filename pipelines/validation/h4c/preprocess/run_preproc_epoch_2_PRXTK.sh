#!/bin/bash
#SBATCH --job-name=preprocess_PRXTK_epoch_2
#SBATCH --partition=hera
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=15
#SBATCH --mem=250G
#SBATCH --time=256:00:00
#SBATCH --output=preprocess_PRXTK_epoch_2.out
#SBATCH --export=ALL
...
${preprocess_dir}/preprocess_data.py ${preprocess_dir}/preprocess_params_epoch_2_PRXTK.yaml 
