#!/bin/bash
#SBATCH --job-name=preprocess_PRTK_epoch_3
#SBATCH --partition=hera
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=15
#SBATCH --mem=250G
#SBATCH --time=256:00:00
#SBATCH --output=preprocess_PRTK_epoch_3.out
#SBATCH --export=ALL
...
${preprocess_dir}/preprocess_data.py ${preprocess_dir}/preprocess_params_epoch_3_PRTK.yaml 
